...
def deploy() -> None:
    ...
    artifacts_path = Path(__file__).parent / ".." / "artifacts" / "yt_token"
    
    # Read approval program
    with open(artifacts_path / "YTToken.approval.teal", 'r') as f:
        approval_teal = f.read()
    
    # Read clear program  
    with open(artifacts_path / "YTToken.clear.teal", 'r') as f:
        clear_teal = f.read()
    ...
    print(f"YT Token contract deployed successfully! App ID: {app_id}")
